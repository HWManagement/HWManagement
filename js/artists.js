...
(function (global) {
  const artists = [
    ...
    { slug: "brockett-parsons", name: "Brockett Parsons", tags: ["Hip-Hop"], unreleased: false, exclusive: true, featured: false, line: "Los Angeles keyboardist and session player known for live hip-hop and pop stages. A touring keys voice behind major rap and R&B shows." },
    { slug: "sy", name: "SY", tags: ["Hip-Hop"], unreleased: false, exclusive: true, featured: false, line: "Independent hip-hop artist. A contemporary voice on the HW Entertainment roster." },
