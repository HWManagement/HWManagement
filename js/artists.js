...
(function (global) {
  const artists = [
    ...
    { slug: "celly-cel", name: "Celly Cel", tags: ["Hip-Hop", "West Coast"], unreleased: true, exclusive: false, featured: false, line: "Vallejo rapper who helped define 1990s Bay Area street rap. Known for Killa Kali and a long run of West Coast radio records." },
    ...
    { slug: "planet-asia", name: "Planet Asia", tags: ["Hip-Hop", "West Coast"], unreleased: true, exclusive: false, featured: false, line: "Fresno MC and Cali underground staple. Known for dense lyricism, Cali Agents, and a vast independent West Coast catalog." },
    ...
    { slug: "juice-wrld", name: "Juice WRLD", note: "catalog licensed features", tags: ["Hip-Hop"], unreleased: false, exclusive: true, featured: false, line: "Chicago melodic-rap star who helped define late-2010s emo rap. Known for Goodbye & Good Riddance and a generation of singing-rap records." },
    ...
    { slug: "brotha-lynch-hung", name: "Brotha Lynch Hung", tags: ["Hip-Hop", "West Coast"], unreleased: false, exclusive: true, featured: false, line: "Sacramento horrorcore pioneer. Known for a grim, narrative West Coast style that influenced a generation of independent rap." },
    ...
    { slug: "sleep-of-oldominion", name: "Sleep of Oldominion", tags: ["Hip-Hop", "West Coast"], unreleased: false, exclusive: true, featured: false, line: "Pacific Northwest independent MC and Oldominion crew member. Known for underground West Coast and PNW lyricism." },
    ...
    { slug: "edi-mean", name: "Edi Mean", note: "The Outlawz", tags: ["Hip-Hop", "West Coast", "Legacy"], unreleased: false, exclusive: true, featured: false, line: "Outlawz member known for records alongside Tupac. A core voice from Still I Rise and the group's post-90s catalog." },
