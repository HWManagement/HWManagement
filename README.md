...
- **Celly Cel** — no free high-res Commons/Wikidata P18 photo (only a 429×625 source). Catalog uses the on-brand West Coast placeholder; bio unchanged.
...
- **Lil B The Based God** — Wikimedia Commons `Lil B 2011.png` (CC BY 2.0, photo: https://www.flickr.com/photos/generationbass/). Uncropped original used for catalog.
...
- **Planet Asia** — no free high-res Commons/Wikidata P18 photo (only a 300×400 source). Catalog uses the on-brand West Coast placeholder; bio unchanged.
...
- **DaBaby** — Wikimedia Commons `DaBaby ATL Bday Bash 2023.png` (CC BY 3.0, photo: HOTSPOTATL).
- **Ne-Yo** — Wikimedia Commons `Ne-Yo (15329874953).jpg` (CC BY-SA 2.0, photo: U.S. Department of the Interior).
...
- **Juice WRLD** — no free high-res Commons/Wikidata P18 portrait (only a 371×458 VMA still). Catalog uses the on-brand placeholder; bio unchanged.
- **WC** — Wikimedia Commons `WC (rapper).jpg` (CC BY 2.5, photo: Tana Cox from Long Beach, Ca, USA).
- **Brotha Lynch Hung** — no free high-res Commons/Wikidata P18 photo (only a 295×494 source). Catalog uses the on-brand West Coast placeholder; bio unchanged.
...
- **Sleep of Oldominion** — no free high-res Commons/Wikidata P18 photo (only a 315×422 source). Catalog uses the on-brand West Coast placeholder; bio unchanged.
- **Freddie Gibbs** — Wikimedia Commons `MadGibbs2014 (cropped).jpg` (CC BY-SA 2.0, photo: Carl Pocket).
- **Andre Nickatina** — Wikimedia Commons `Andre Nickatina performing at UCLA.jpg` (CC BY-SA 2.0, photo: Kamyar Shahmoradi from Santa Monica, U.S.).
- **Ill Bill** — Wikimedia Commons `Ill Bill.jpg` (CC BY-SA 3.0, photo: ldbergeron (Flickr profile)).
- **Mistah F.A.B.** — Wikimedia Commons `Mistah F.A.B. by Brian Solis.jpg` (CC BY 2.0, photo: Brian Solis).
- **Kokane** — Wikimedia Commons `Kokane, 2011.jpg` (CC BY-SA 3.0, photo: Budeboyjournalist).
- **Edi Mean** — no free high-res Commons/Wikidata P18 photo (only a 513×725 source). Catalog uses the on-brand West Coast placeholder; bio unchanged.
...
- **Bizzy Bone** — Wikimedia Commons `Bizzy Bone (20770874923).jpg` (CC BY 2.0, photo: The Come Up Show).
